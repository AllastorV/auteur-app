...
| Electron 44.4.5 and Chromium | Electron MIT and individual Chromium component licenses | The packaged Electron runtime's `LICENSE` and `LICENSES.chromium.html` files. |
